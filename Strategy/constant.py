...
MOTION = {
    3: {
        'MOVE': {  # offset[verticle(, horizon)]
            ...
            # BOUND': [15] ;[4]
            'LEFT': {'CMD': ['A', 'a'], 'BOUND': [19.5, 1.33], 'OFFSET': [13.5]},
            # BOUND': [75,15] ;[71, 3.1]
            'RIGHT': {'CMD': ['D', 'd'], 'BOUND': [19.5, 1.275], 'OFFSET': [13.5]}
            #  [76, 2.22]
        },
    ...
    4: {
        'MOVE': {  # offset[verticle(, horizon)]
            ...
            'BACK': {'CMD': ['s'], 'BOUND': [2], 'OFFSET': [16, 6]},
            # BOUND': [15] ;[4]
            'LEFT': {'CMD': ['A', 'a'], 'BOUND': [18.5, 1.33], 'OFFSET': [13.5]},
            # BOUND': [75,15] ;[71, 3.1]
            'RIGHT': {'CMD': ['D', 'd'], 'BOUND': [16.5, 1.275], 'OFFSET': [13.5]}
            #  [76, 2.22]
        },
